...
<?
       ...
       //   $error = '<div class="error_message">Attention! Phone number can only contain digits.</div>';
        ...
        if($error == '') {
         ...
         $address = "auctionoftnl@yahoo.com";
         ...
         $e_subject = 'You\'ve been contacted by ' . $name . ' via www.tandlauctionservice.com.';
		 ...
		 $e_body = "You have been contacted by $name via the contact form on your website. Their message is as follows:\r\n\n";
		 $e_content = "Subject: \"$subject\" \r\n\n \"$comments\"\r\n\n";
...
?>
            ...
            <legend>Please fill in the following form to contact us.<br /><span class="required">*</span><span style="font-size:12px">Required</span></legend>
			...
			<br />
             <label for=email><span class="required">*</span>Would you like a reply?</label>
            <input name="email" type="text" id="email" size="30" value="<?=$reply;?>" />
 ...
 -->
            ...
            <label for=email accesskey=S><span class="required">*</span> Subject</label>
